...
const querySnapshot = await db.collection("invitadosXVVictoriaOctubre18").get();
...
function enviarWhatsApp(nombre, numeroInvitados) {
  ...
  const numeroTelefono = "+5216672279073"; // Reemplaza con el número de teléfono al que deseas enviar el mensaje
